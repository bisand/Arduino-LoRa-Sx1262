...
public:
  ...
  bool configSetPowerLevel(uint8_t powerLevel);
  bool configSetSyncWord(uint8_t syncWord);
  ...
  LoraSx1262(uint8_t dio1, uint8_t nss, uint8_t reset);
